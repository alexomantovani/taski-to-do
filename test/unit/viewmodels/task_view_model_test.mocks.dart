...
// in taski_to_do/test/unit/viewmodels/task_view_model_test.dart.
...
import 'package:taski_to_do/models/task_model.dart' as _i4;
import 'package:taski_to_do/repositories/task_repository.dart' as _i2;
...
class MockTaskRepository extends _i1.Mock implements _i2.TaskRepository {
  ...
  @override
  _i3.Future<void> addTask(_i4.TaskModel? task) => (super.noSuchMethod(
        Invocation.method(
          #addTask,
          [task],
        ),
